...
import { Form, Container, Row, Col, InputGroup, Alert, Button } from 'react-bootstrap';
...
var GenerateFormField = /*#__PURE__*/function (_PureComponent) {
  ...
  _proto.render = function render() {
    var _this2 = this;
    return /*#__PURE__*/React.createElement(React.Fragment, null, this.props.group && /*#__PURE__*/React.createElement("div", {
      className: "docx-template__group-name"
    }, this.props.group), /*#__PURE__*/React.createElement(Form.Group, {
      className: "fluid",
    ...
    }, this.props.label, " ", this.props.required === 1 && /*#__PURE__*/React.createElement("span", {
      style: {
        color: 'red'
      }
    ...
    }), this.props.type === FILE_TEMPLATE_FIELD_TYPES.FIXED_DATE.value && /*#__PURE__*/React.createElement(DatePicker, {
    ...
    }), this.props.type === FILE_TEMPLATE_FIELD_TYPES.SINGLE_CHOICE_OPTION.value && /*#__PURE__*/React.createElement(Dropdown, {
      className: "form-control",
    ...
    }), this.props.explanation && this.props.explanation !== '' && /*#__PURE__*/React.createElement("div", {
  ...
  _proto.render = function render() {
    ...
    if (isLoading) {
      ...
      content = /*#__PURE__*/React.createElement(Alert, {
        variant: "danger"
      }, /*#__PURE__*/React.createElement(Alert.Heading, null, "We're sorry, something went wrong"), /*#__PURE__*/React.createElement("p", null, "Template file can not be loaded"));
    } else {
      ...
      }, /*#__PURE__*/React.createElement(Container, null, /*#__PURE__*/React.createElement(Row, null, /*#__PURE__*/React.createElement(Col, null, !!this.props.injectedFieldsBefore && this.props.injectedFieldsBefore, this.renderFields(docFields), Object.entries(this.state.hideableFields).length > 0 && /*#__PURE__*/React.createElement(Form.Field, null, /*#__PURE__*/React.createElement("label", null, "Optional Clauses"), Object.entries(this.state.hideableFields).map(function (field) {
      ...
      })), !!this.props.injectedFieldsAfter && this.props.injectedFieldsAfter)), /*#__PURE__*/React.createElement(Row, null, /*#__PURE__*/React.createElement(Col, null, /*#__PURE__*/React.createElement("div", {
